                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="furnitures.php">Products</a>
                              </li>
                              ...
                              <li class="nav-item">
							   <li class="nav-item">
                                 ...
                                 <a class="nav-link" href="garely.php">Album</a>
                              </li>
...
?>	
<?php
$affichmedecin=$conn->query("select*from testimonie");
?>
									  <table >
	<tr>
...
<tr>
<td>
<h4><?php echo $bdmedecins["nom"]; ?> </h4>
 <span>(It is a long )</span>
</td>
<td>
<?php echo $bdmedecins["testimonie"]; ?>
</td>
<?php
}
?>
               ...
               <div class="row">
                  ...
                  <div class="col-md-8">
                     <ul class="location_icon">
                        ...
                        <li><a href="#"><i class="fa fa-volume-control-phone" aria-hidden="true"></i></a> +25771174380</li>
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>karireproducts@gmail.com</li>
                     </ul>
                  </div>
                  <div class="col-md-6">
